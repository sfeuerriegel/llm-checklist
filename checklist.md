...
|---------------|--------|
| **Justification for LLM choice** | Performance, <br> Transparency,<br> Reproducibility<br> Ethical considerations<br> Others (e.g., cost, ease-of-use) |
| **Rationale for prompt design** | Yes. Description:<br> No<br> N/A |
